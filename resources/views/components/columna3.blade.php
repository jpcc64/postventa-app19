<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 gap-4">
        ...
        <div>
            ...
            <input type="date" name="CreationDate" disabled id="CreationDate" class="mt-1 block w-full rounded-md border border-gray-400 bg-gray-50 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
        ...
        <div>
            ...
            <input type="date" name="ResolutionOnDate" disabled id="ResolutionOnDate" class="mt-1 block w-full rounded-md border border-gray-400 bg-gray-50 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
