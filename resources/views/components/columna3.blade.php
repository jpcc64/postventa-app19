        ...
        @if(isset($parte))
            <div>
                ...
                <select name="Status"
                    ...
                    <option value="-3" {{ (isset($parte['Status']) && $parte['Status'] == -3) ? 'selected' : '' }}>Abierto
                    </option>
                    <option value="-2" {{ (isset($parte['Status']) && $parte['Status'] == -2) ? 'selected' : '' }}>En proceso
                    </option>
                    <option value="-1" {{ (isset($parte['Status']) && $parte['Status'] == -1) ? 'selected' : '' }}>Cerrado
                    </option>
                </select>
