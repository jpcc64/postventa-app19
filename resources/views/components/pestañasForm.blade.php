            ...
            <div x-show="tab === 'anexo'" x-cloak x-transition class="space-y-4 mb-6">
                <div class="flex w-full gap-4">
                    ...
                    <div id="preview-container"
                        class="w-1/2 h-64 overflow-y-auto grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 bg-white rounded-lg border border-gray-200 p-2">
                ...
                if (dropZone) {
                    ...
                    function createPreview(file) {
                        ...
                        reader.onload = function (e) {
                            ...
                            previewItem.innerHTML = `<div class="border border-gray-400 rounded">
                                        ${filePreview}
                                        <div class="file-info"><p class="file-name">${file.name}</p></div>
                                        <button type="button" class="remove-file-btn" title="Eliminar archivo">&times;</button> </div>`;
