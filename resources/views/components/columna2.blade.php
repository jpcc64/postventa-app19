<div class="space-y-1 grid grid-cols-2 gap-2 rounded-md">
    ...
    <div class="col-span-2 grid grid-cols-2">
        ...
        <input type="text" name="Subject" class=" block w-full rounded-md border border-gray-400 bg-gray-50 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 p-1"
    ...
    <div class="col-span-2 grid grid-cols-2">
        ...
        <input type="text" name="U_H8_RMA" class=" block w-full rounded-md border border-gray-400 bg-gray-50 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 p-1"
    ...
    <div class="col-span-2 grid grid-cols-2">
        ...
        <select name="U_H8_MOTIVO" id="" class=" block w-full rounded-md border border-gray-400 bg-gray-50 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
            ...
            <option value="ST" {{ old('U_H8_MOTIVO', $parte['U_H8_MOTIVO'] ?? '') == 'ST' ? 'selected' : '' }}>Servicio técnico</option>
            <option value="DEV" {{ old('U_H8_MOTIVO', $parte['U_H8_MOTIVO'] ?? '') == 'DEV' ? 'selected' : '' }}>Proveedor</option>
        </select>
